...
import { generateISPNotification } from '../../api/groqActions.js'
...
export default function ForensicsReport({ incident: inc, onClose }) {
  ...
  const groqApiKey = useSHYENStore(s => s.groqApiKey)
  ...
  async function draftNocEmail() {
    ...
    try {
      ...
      const text = await generateISPNotification(inc, analysis, groqApiKey)
      setNocDraft(text)
    } catch (e) {
